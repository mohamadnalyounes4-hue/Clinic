...
class _HealthInformationScreenState extends State<HealthInformationScreen> {
  ...
  void _continue() {
    ...
    if (_gender == null) {
      _showSnackBar(context.tr('حدد الجنس'));
      return;
    }
  ...
  String? _conditionalRequiredValidator(
    String? value, {
    ...
    return _AnimatedEntrance(
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(
              color: NabadColors.primary.withAlpha(30),
              blurRadius: 30,
            ...
            DecoratedBox(
              decoration: BoxDecoration(
                gradient: LinearGradient(
                  ...
                  colors: [
                    NabadColors.primary.withAlpha(225),
                    NabadColors.primary.withAlpha(128),
                    Colors.transparent,
                  ],
                ),
              ),
          ...
          children: [
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  Text(
                    context.tr('اكتمل {count} من 4', {'count': _doneCount}),
                    style: const TextStyle(
        ...
        child: Column(
          ...
          children: [
            _SectionTitle(
              ...
              title: context.tr('المعلومات الأساسية'),
            ),
            ...
            _HealthTextField(
              ...
              label: context.tr('تاريخ الميلاد'),
              hintText: context.tr('اختر تاريخ الميلاد'),
            ...
            // Gender
            _FieldLabel(label: context.tr('الجنس')),
            const SizedBox(height: 8),
            DropdownButtonFormField<String>(
              value: gender,
              isExpanded: true,
              decoration: _inputDecoration(
                hintText: context.tr('اختر الجنس'),
              ...
              validator: (value) =>
                  value == null ? context.tr('الجنس مطلوب') : null,
            ),
            const SizedBox(height: 16),
            ...
            _HealthTextField(
              ...
              hintText: context.tr('مثال: دمشق، سوريا'),
            ...
            // Blood Type
            _FieldLabel(label: context.tr('زمرة الدم')),
            const SizedBox(height: 8),
            DropdownButtonFormField<String>(
              value: bloodType,
              isExpanded: true,
              decoration: _inputDecoration(
                hintText: context.tr('اختر زمرة الدم'),
              ...
              validator: (value) =>
                  value == null ? context.tr('زمرة الدم مطلوبة') : null,
            ),
            const SizedBox(height: 22),

            _SectionTitle(
              icon: Icons.health_and_safety_rounded,
              title: context.tr('الحالة الصحية'),
            ),
            const SizedBox(height: 14),

            _AnimatedHealthQuestion(
              question: context.tr('هل لديك مرض مزمن؟'),
            ...
            _ConditionalAnimatedField(
              ...
              child: _HealthTextField(
                ...
                label: context.tr('وصف المرض المزمن'),
                hintText: context.tr('اكتب وصف المرض المزمن'),
                icon: Icons.edit_note_rounded,
                maxLines: 3,
                validator: (value) => conditionalRequiredValidator(
                  value,
                  isRequired: hasChronicDisease == true,
            ...
            _AnimatedHealthQuestion(
              question: context.tr('هل لديك حساسية؟'),
              description: context.tr(
            ...
            _ConditionalAnimatedField(
              ...
              child: _HealthTextField(
                ...
                label: context.tr('وصف الحساسية'),
                hintText: context.tr('اكتب نوع الحساسية'),
                icon: Icons.edit_note_rounded,
                maxLines: 3,
                validator: (value) => conditionalRequiredValidator(
                  value,
                  isRequired: hasAllergy == true,
                  label: 'وصف الحساسية',
                ),
              ),
            ),
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: value == null
              ...
              : NabadColors.primary.withAlpha(52),
        ),
      ),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.stretch,
    ...
    return InkWell(
      ...
      child: AnimatedContainer(
        ...
        child: Text(
          label,
          style: TextStyle(
            color: isSelected ? Colors.white : NabadColors.deepTeal,
            fontWeight: FontWeight.w900,
          ),
        ),
      ),
...
class _ConditionalAnimatedField extends StatelessWidget {
  ...
  const _ConditionalAnimatedField({
  ...
  Widget build(BuildContext context) {
    return AnimatedSwitcher(
      ...
      child: isVisible
          ? Padding(
              key: const ValueKey('visible-field'),
